...
public class RURacing {
    ...
    public static void racer1(char[][] map) {
        ...
        int currentX = 0;
        int currentY = 0;
        int[] position = moveRacer(currentX, currentY, distanceNum, map);
        System.out.println("Racer1 is at: (" + position[0] + "," + position[1] + ")");
    }
    ...
    public static void racer2(char[][] map) {
        ...
        while(distanceNum > 0) {
            ...
            int[] newCoords = moveRacer(currentX, currentY, speed, map);
            ...
            speed *= 2;
            if(!(distanceNum <= 0)) {
                System.out.println("Racer2 is at: (" + currentX + "," + currentY + ")");
            } else {
    ...
    public static void racer3(char[][] map) {
        ...
        while(distanceNum > 0) {
            ...
            distanceNum -= speed;
            if(!(distanceNum <= 0)) {
                System.out.println("Racer3 is at: (" + currentX + "," + currentY + ")");
            } else {
                System.out.println("Racer3 is at: (0,0)");
            }
        }
        ...
        while(distanceNum > 0) {
            ...
            if(!(distanceNum <= 0)) {
                for(int i = 0; i < (PlaceHolder-1); i++) {
                    System.out.println("Racer4 is at: (" + currentX + "," + currentY + ")");
                }
